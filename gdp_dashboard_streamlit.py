# GDP Analysis Dashboard — Streamlit Edition
# Modern, clean, professional dark-themed dashboard
...
# ──────────────────────────────────────────────────────────────
# Custom CSS — deep dark professional theme
# ──────────────────────────────────────────────────────────────
...
<style>
    ...
    /* Selectbox, multiselect, number input */
...
with st.sidebar:
    ...
    # ── Analysis Type ────────────────────────────────────────
    st.markdown('<div class="sidebar-section">📈 Analysis Type</div>', unsafe_allow_html=True)
    ...
    # ── Country Selection ────────────────────────────────────
    st.markdown('<div class="sidebar-section">🌐 Country Selection</div>', unsafe_allow_html=True)
    ...
    country_var = st.selectbox("Primary Country", countries, index=countries.index(default_country))

    compare_countries = st.multiselect(
        "Compare With",
        options=list(filter(lambda c: c != country_var, countries)),
        default=list(filter(
    ...
    # ── Continent ────────────────────────────────────────────
    st.markdown('<div class="sidebar-section">🗺️ Continent</div>', unsafe_allow_html=True)
    ...
    # ── Top N ────────────────────────────────────────────────
    st.markdown('<div class="sidebar-section">🏆 Top N Countries</div>', unsafe_allow_html=True)
...
with kpi_cols[2]:
    st.metric("🏛️ Countries", f"{data_summary['total_countries']}")
with kpi_cols[3]:
    st.metric("📅 Years", f"{data_summary['total_years']}")


# ══════════════════════════════════════════════════════════════
# HELPER — build engine params
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# HELPER — engine results as dataframe + chart
# ══════════════════════════════════════════════════════════════
